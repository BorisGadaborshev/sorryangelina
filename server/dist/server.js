...
const removeRoomPresence = (roomId, userName, socketId) => {
...
io.on('connection', (socket) => {
    ...
    socket.on('toggle-card-reaction', ({ cardId, emoji }) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            if (!room || !canInteractWithCardSocial(room.phase))
                return;
            if (!getRoomFeatures(room).reactionsEnabled)
                return;
    ...
    socket.on('vote-sprint-vip', ({ userName }) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            if (!room)
                return;
            if (!getRoomFeatures(room).sprintVipEnabled)
                return;
    ...
    socket.on('submit-retro-rating', ({ value }) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            if (!room || room.phase !== 'rating')
                return;
            if (!getRoomFeatures(room).retroRatingEnabled)
                return;
    ...
    socket.on('send-chat-message', ({ text }) => __awaiter(void 0, void 0, void 0, function* () {
        if (!(currentUser === null || currentUser === void 0 ? void 0 : currentUser.roomId))
            return;
        const room = yield RoomService_1.RoomService.getRoom(currentUser.roomId);
        if (!room || !getRoomFeatures(room).chatEnabled)
            return;
    ...
    socket.on('whiteboard-stroke', (payload) => __awaiter(void 0, void 0, void 0, function* () {
        if (!(currentUser === null || currentUser === void 0 ? void 0 : currentUser.roomId))
            return;
        const room = yield RoomService_1.RoomService.getRoom(currentUser.roomId);
        if (!room || !getRoomFeatures(room).drawingEnabled)
            return;
    ...
    socket.on('clear-whiteboard', () => __awaiter(void 0, void 0, void 0, function* () {
        if (!(currentUser === null || currentUser === void 0 ? void 0 : currentUser.roomId))
            return;
        const room = yield RoomService_1.RoomService.getRoom(currentUser.roomId);
        if (!room || !getRoomFeatures(room).drawingEnabled)
    ...
    socket.on('transfer-room-admin', ({ userId }) => __awaiter(void 0, void 0, void 0, function* () {
        if (!(currentUser === null || currentUser === void 0 ? void 0 : currentUser.roomId) || typeof userId !== 'string')
            return;
        try {
            const updatedRoom = yield RoomService_1.RoomService.transferRoomAdmin(currentUser.roomId, currentUser.id, userId, currentUser.name);
            if (!updatedRoom) {
    ...
    socket.on('kick-user', ({ userId }) => __awaiter(void 0, void 0, void 0, function* () {
        if (!(currentUser === null || currentUser === void 0 ? void 0 : currentUser.roomId) || typeof userId !== 'string' || userId === currentUser.id)
            return;
        try {
            const room = yield RoomService_1.RoomService.getRoom(currentUser.roomId);
            if (!room)
    ...
    socket.on('leave-room', () => __awaiter(void 0, void 0, void 0, function* () {
        if (!(currentUser === null || currentUser === void 0 ? void 0 : currentUser.roomId))
            return;
        try {
